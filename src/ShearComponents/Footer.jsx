...
const Footer = () => {
  ...
  <nav>
    ...
    <a className="link link-hover">AirCover for hosting</a>
  ...
  <nav>
    ...
    <a className="link link-hover">Carrears </a>
  </nav>
</footer>
<footer className="footer bg-base-200 text-base flex justify-between
  p-10 border-t-base-300">
